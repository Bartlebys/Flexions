...
if (!defined('BJM_INFOS')) {
    ...
    define('BJM_UID', 'uid'); // We use uid only if we need to reuse the same Template multiple time (E.g Multiple BartlebyDocument)
    ...
    define('BJM_NATURE','nature');
    define('BJM_BASE_OBJECT','baseObject');
