...
class EntityRepresentation {
    ...
    /***
     * @var string you can setup a nature to discriminate some entities (e.g: UnManagedModel)
     */
    public $nature;
    /**
    ...
    /**
     * @var bool set to true if the Entity is the base Object
     */
    public $baseObject = false;

    public function isBaseObject(){
        return $this->baseObject;
    }


    /**
     * Return if the entity is a value Object (value objects are ligther)
     * @return bool
     */
    public function isUnManagedModel(){
        if (isset($this->nature)) {
            if (trim(strtolower($this->nature)) == strtolower("UnManagedModel")) {
                return true;
            }
        }
        return false;
