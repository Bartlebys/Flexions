...
// MARK: An object that uses composition (allOf)
@objc(ComposedEntity) open class ComposedEntity : JObject{
    ...
    override open var exposedKeys:[String] {
        ...
        exposed.append(contentsOf:["name","informativeString","notes","creationDate","tags","color","icon"])
        return exposed
    }
    ...
    override open var d_collectionName:String{
        return ComposedEntity.collectionName
    }
